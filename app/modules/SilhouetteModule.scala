...
import models.services.{ ContactService, ContactServiceImpl, DownloadService, DownloadServiceImpl, SupportService, SupportServiceImpl, UserService, UserServiceImpl }
...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  override def configure(): Unit = {
    ...
    bind[ContactDAO].to[ContactDAOImpl]
    bind[SupportService].to[SupportServiceImpl]
    bind[SupportDAO].to[SupportDAOImpl]
    bind[DownloadService].to[DownloadServiceImpl]
    bind[DownloadDAO].to[DownloadDAOImpl]
    ...
    //bind[DelegableAuthInfoDAO[PasswordInfo]].toInstance(new PersistedAuthInfoDAO())
  ...
  def providesAuthInfoDAO(db: Database)(
    implicit
    ex: DatabaseExecutionContext): DelegableAuthInfoDAO[PasswordInfo] = {
