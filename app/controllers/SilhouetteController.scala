...
import models.services.{ AuthTokenService, ContactService, DownloadService, SupportService, UserService }
...
abstract class SilhouetteController(override protected val controllerComponents: SilhouetteControllerComponents)
  ...
  def contactService: ContactService = controllerComponents.contactService
  def supportService: SupportService = controllerComponents.supportService
  def downloadService: DownloadService = controllerComponents.downloadService
...
trait SilhouetteComponents {
  ...
  def supportService: SupportService
